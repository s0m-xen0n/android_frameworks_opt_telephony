...
public abstract class IratDataSwitchHelper extends Handler {
    ...
    public void setPsServiceType(int psServiceType) {
        ...
        // Sync and notify data attach state when PS type changed.
    ...
    protected int getSvltePhoneProxyMode() {
        // TODO: get SVLTE phone proxy mode from phone proxy.
        return SvlteIratUtils.PHONE_IN_SVLTE_MODE;
    }
