...
import com.mediatek.internal.telephony.ltedc.svlte.SvlteRatController.EngineerMode;
...
public class SvlteIrController {
    ...
    private abstract class PhoneController extends Handler implements INetworkController {
        ...
        protected void setServiceType(ServiceType serviceType) {
            logdForController(" setServiceType(" + serviceType + ") mServiceType = " + serviceType);
            ...
            switch (msg.what) {
                ...
                case EVENT_SERVICE_STATE_CHANGED:
                    ...
                    if (regState == ServiceState.RIL_REG_STATE_HOME
                        ...
                        mIsFirstRoundSearch = true;
                    } else if ((mPreVoiceState == ServiceState.RIL_REG_STATE_SEARCHING
                                || mPreDataState == ServiceState.RIL_REG_STATE_SEARCHING)
                               && (regState == ServiceState.RIL_REG_STATE_NOT_REG
    ...
    private class Strategy5M extends Strategy {
        ...
        protected void switchForNoService(boolean forceSwitch) {
            ...
            if (!isDualRadioOff() && supportRoaming() && isSimReady()) {
                ...
                if (mNoServiceTimeStamp == 0 ||
                    ...
                    if (mIrController.getRoamingMode() == RoamingMode.ROAMING_MODE_HOME) {
                        mIrController.setRoaming(RoamingMode.ROAMING_MODE_NORMAL_ROAMING,
                                   obtainMessage(EVENT_ROAMING_MODE_CHANGED));
                    } else {
                        mIrController.setRoaming(RoamingMode.ROAMING_MODE_HOME,
                                   obtainMessage(EVENT_ROAMING_MODE_CHANGED));
                    }
