...
import com.android.internal.telephony.MMTelSSTransport;
...
public class ImsUtStub extends IImsUt.Stub {
   ...
   private Handler mHandler = new Handler() {
     ...
     * @return the request ID
     */
    public int updateCallForward(int action, int condition, String number, int timeSeconds) {
        int requestId;
        ...
        mMMTelSSTSL.setCallForward(getCFActionFromAction(action),
                getCFReasonFromCondition(condition), CommandsInterface.SERVICE_CLASS_VOICE,
     ...
     * @return the request ID
     */
    public int updateCallWaiting(boolean enable) {
        int requestId;
        ...
        mMMTelSSTSL.setCallWaiting(enable, CommandsInterface.SERVICE_CLASS_VOICE, msg);
    ...
    public int updateCallBarring(int cbType, int action, String[] barrList) {
        Log.w(TAG, "updateCallBarring: stub!");
        return 0;
    }
    ...
    public int updateCallForward(int action, int condition, String number,
        ...
        Log.w(TAG, "updateCallForward: stub!");
        return 0;
    }
    ...
    public int updateCallForwardUncondTimer(int startHour, int startMinute, int endHour,
        ...
        Log.w(TAG, "updateCallForwardUncondTimer: stub!");
        return 0;
    }
    ...
    public int updateCallWaiting(boolean enable, int serviceClass) {
        Log.w(TAG, "updateCallWaiting(" + enable + ", " + serviceClass + "): stub!");
        return 0;
    }
    ...
    public int queryCFForServiceClass(int condition, String number, int serviceClass) {
        Log.w(TAG, "queryCFForServiceClass(" + condition + ", \"" + number + "\", " + serviceClass + "): stub!");
        return 0;
    }
