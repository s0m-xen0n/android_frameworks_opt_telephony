...
public abstract class PhoneBase extends Handler implements Phone {
    ...
    /// @}
    protected static final int EVENT_LAST                   = EVENT_PHONE_RAT_FAMILY_CHANGED_NOTIFY;  // EVENT_GET_CALLFORWARDING_STATUS;
   ...
   //Telephony System Property used to indicate a multimode target
     ...
     */
    public /* MTK */ static class NetworkSelectMessage {
    ...
    public void dispose() {
        synchronized(PhoneProxy.lockForRadioTechnologyChange) {
            ...
            mUiccController.unregisterForApplicationChanged(this);  // xen0n fix
    ...
    */
    ...
    public int getSubId() {
        ...
        // xen0n: fxxk, CdmaFeatureOptionUtils fxxking EVERYWHERE
        // TODO: I don't know how many valid cases are there going without the additional mapping step,
        // if there isn't any I would immediately swap this in.
        /*
        final int subId = SubscriptionController.getInstance().getSubIdUsingPhoneId(mPhoneId);
        return CdmaFeatureOptionUtils.isCdmaLteDcSupport() ? SvlteUtils.getSvlteSubIdBySubId(subId) : subId;
        */
    }
