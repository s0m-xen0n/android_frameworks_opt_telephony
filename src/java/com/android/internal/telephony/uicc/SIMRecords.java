    ...
    public void handleMessage(Message msg) {
        ...
        try { switch (msg.what) {
            ...
            case EVENT_GET_IMSI_DONE:
                ...
                if ((/* MTK */ (mMncLength == UNINITIALIZED) || (mMncLength == UNKNOWN) || (mMncLength == 2)) &&
                ...
                if (mMncLength == UNKNOWN || /* MTK */ mMncLength == UNINITIALIZED) {
            ...
            case EVENT_GET_MBI_DONE:
                ...
                } else /* MTK */ if (isCphsMailboxEnabled()) {
...
//MTK-END [mtk80601][111215][ALPS00093395]
        ...
        switch(efid) {
            ...
            */
            ...
            default:
                ...
                // MTK
                log("handleFileUpdate default: efid=" + efid);
    ...
    protected void onAllRecordsLoaded() {
        ...
        if (!TextUtils.isEmpty(mImsi)) {
            ...
            setSystemProperty(PROPERTY_ICC_OPERATOR_ISO_COUNTRY, countryCode);
        } else {
        ...
        if (operator != null) {
            ...
            */
            if (mSpnOverride.containsCarrier(operator)) {
                newName = mSpnOverride.getSpn(operator);
            }
