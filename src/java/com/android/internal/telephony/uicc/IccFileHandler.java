            ...
            case EVENT_GET_EF_LINEAR_RECORD_SIZE_DONE:
             ...
             case EVENT_GET_RECORD_SIZE_DONE:
                ...
                if (UiccTlvData.isUiccTlvData(data)) {
                 ...
                 // MTK
                 if (lc.mMode != -1) {
                    mCi.iccIOForAppEx(COMMAND_READ_RECORD, lc.mEfid, path /* getSmsEFPath(lc.mMode) */,
                            lc.mRecordNum,
                            READ_RECORD_MODE_ABSOLUTE,
                            lc.mRecordSize, null, null, mAid, lc.mChannel,
                            obtainMessage(EVENT_READ_RECORD_DONE, lc));
                } else {
                    mCi.iccIOForAppEx(COMMAND_READ_RECORD, lc.mEfid, path /* getEFPath(lc.mEfid) */,
                            lc.mRecordNum,
                            READ_RECORD_MODE_ABSOLUTE,
                         lc.mRecordSize, null, null, mAid, lc.mChannel,
                            obtainMessage(EVENT_READ_RECORD_DONE, lc));
